...
import { FileText, Image, Package, ShoppingCart, ImageIcon, ExternalLink, Globe } from 'lucide-react';
...
export default function AdminDashboardPage() {
  ...
  const dashboardCards = [
    {
      title: 'Edit Text',
      description: 'Manage site text and translations',
      icon: FileText,
    ...
    },
    {
      ...
      description: 'Save design reference and inspiration',
      icon: Globe,
  ...
  return (
    <div className="container py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage your agricultural products store</p>
      </div>
        ...
        <Card className="mb-8 border-cyan-200 dark:border-cyan-800">
          ...
          <CardContent>
            {referenceWebsite ? (
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="flex-1">
                    <p className="text-sm font-medium text-muted-foreground mb-1">Saved URL</p>
              ...
              <Alert>
                <AlertDescription>
                  No reference website has been set yet.{' '}
